...
const TileChart = ({ data, range = 6, onTileHover, tileText, }) => {
    ...
    const [popup, setPopup] = require$$0.useState();
    const [popupTimeout, setPopupTimeout] = require$$0.useState();
